  ...
  return knex('gifts').del()
    .then(function () {
      ...
      return knex('gifts').insert([
        ...
        {donor_id: 9, donor_name: 'Marlon Smith', program: 'Homelessness', gift_amount: '$500.00', gift_date: '05/10/2017', transaction_type: 'Certified Check', receipt_status: 'Not Provided'},

        {donor_id: 10, donor_name: 'Betsy McBooger', program: 'Homelessness', gift_amount: '$1,500.00', gift_date: '11/19/2017', transaction_type: 'Credit Card', receipt_status: 'Provided'},

        {donor_id: 4, donor_name: 'Martha Jones', program: 'Elder Care', gift_amount: '$750.00', gift_date: '12/24/2017', transaction_type: 'Certified Check', receipt_status: 'Provided'},

        {donor_id: 9, donor_name: 'Marlon Smith', program: 'Homelessness', gift_amount: '$150.00', gift_date: '12/28/2017', transaction_type: 'Credit Card', receipt_status: 'Not Provided'},
